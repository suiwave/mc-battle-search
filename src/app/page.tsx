  ...
  return (
    <div className="container mx-auto px-4 py-16 flex flex-col items-center justify-center min-h-screen gradient-bg">
      <div className="text-center mb-12">
        <h1 className="text-6xl font-bold mb-4 neon-text">Underground Lyrical Arena</h1>
        <p className="text-xl text-purple-300">Where words ignite and legends are forged</p>
      </div>
      <div className="w-full max-w-md space-y-6 bg-black bg-opacity-70 p-8 rounded-lg shadow-lg border border-primary/20">
        ...
        <Link href="/results" className="w-full">
          <Button className="w-full mature-button">
            Ignite the Battle
          </Button>
        </Link>
      </div>
